...
-- Insert books
INSERT INTO books (id, title, author, isbn, price, description, cover_image, is_deleted) VALUES (1, 'A short course in the history of Ukraine', 'Y. Hrytsak', '234-1-235-6-1', 1000, 'About Ukranian history', 'Cover image 1', false);
